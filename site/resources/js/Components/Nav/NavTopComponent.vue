<template>
    <nav :style="{zIndex: 999 }"
        class="top-0 fixed h-[70px] flex items-center justify-between navtop-color z-50 w-full  custom-box-shadow">
        <div class="px-3 lg:px-5 w-full lg:pl-3 nav-menu">
            <div class="flex items-center h-full justify-between">
                <div class="flex">
                    <img  @click.prevent="toggleMenu()" width="26" :src='sidebarMenuStore.getSidebarStatus? "/assets/images/svg12 (1).svg" : "/assets/images/SVG (12) (2).svg"'>
                    <div class="flex items-center margin-logo">
                        <a v-if="setting" href="/" class="mr-3 flex  items-center md:mr-15 gap-2">
                            <div class="hidden margin sm:block">
                        ...
                        <div class="ml-10 date hidden md:block">
                            <p >{{ getDate() }}</p>
                            <p>{{ getTimezone() }}</p>
                        </div>
                    </div>
                ...
                <div v-if="!simple" class="flex items-center py-3">
                    ...
                    <div v-if="!isAuthenticated" class="flex ml-5">
                        <button class="login mr-2" @click.prevent="loginToggle">
                            Login
                        </button>
                        <button @click.prevent="registerToggle" class="registrar h-[46px]  md:mr-3 rounded">
                            Registro
                        </button>
                    </div>
                    ...
                    <div v-if="isAuthenticated" class="flex items-center">
                        <WalletBalance />
                        <MakeDeposit :showMobile="false" :title="'depositar'" />
                        ...
                        <div class="flex items-center ml-3">
                            ...
                            <div
                                class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow navtop-color dark:divide-gray-600"
                                id="dropdown-user">
                                ...
                                <ul class="py-1 list-menu" role="none">
                                    <li>
                                        <RouterLink :to="{ name: 'home' }" active-class="link-active"
                                            ...
                                            <span class="w-8 h-8 mr-3 image">
                                                <img src="/public/assets/images/SVG.svg" />
                                            </span>
                                            {{ $t('Dashboard') }}
                                        </RouterLink>
                                    </li>
                                    <li>
                                        <RouterLink :to="{ name: 'profileAffiliate' }"
                                            ...
                                            class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white">
                                            <span class="w-8 h-8 mr-3 image">
                                                <img src="/public/assets/images/pessoas-setas-esquerda-direita 1.svg" />
                                            </span>
                                            {{ $t('Affiliate') }}
                                        </RouterLink>
                                    </li>
                                    <li>
                                        <RouterLink :to="{ name: 'profileDeposit' }" active-class="profile-menu-active"
                                            class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white">
                                            <span class="w-8 h-8 mr-3 image">
                                                <img src="/public/assets/images/Group 1000001721.svg" />
                                            </span>
                                            {{ $t('Deposit') }}
                                        </RouterLink>
                                    </li>
                                    <li>
                                        <RouterLink :to="{ name: 'profileWithdraw' }" active-class="profile-menu-active"
                                            class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white">
                                            <span class="w-8 h-8 mr-3 image">
                                                <img src="/public/assets/images/Group 1000001721 (1).svg" />
                                            </span>
                                            {{ $t('Withdraw') }}
                                        </RouterLink>
                                    </li>
                                    <li>
                                        <RouterLink :to="{ name: 'profileWallet' }" active-class="profile-menu-active"
                                            class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white">
                                            <span class="w-8 h-8 mr-3 image">
                                                <img src="/public/assets/images/carteira (1) 2.svg" />
                                            </span>
                                            {{ $t('My Wallet') }}
                                        </RouterLink>
                                    </li>
                                    <li>
                                        <a href="#" @click.prevent="profileToggle"
                                            ...
                                            role="menuitem">
                                            <span class="w-8 h-8 mr-3 image">
                                                <img src="/public/assets/images/do-utilizador (2) 1.svg" />
                                            </span>
                                            {{ $t('My Profile') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a @click.prevent="logoutAccount" href="#"
                                            ...
                                            role="menuitem">
                                            <span class="w-8 h-8 mr-3 image">
                                                <i class="fa-duotone white fa-right-from-bracket"></i>
                                            </span>
                                            {{ $t('Sign out') }}
                                        </a>
                                    </li>
            ...
            <div class="flex md:justify-between">
                <div class="w-full relative p-5">
                    <div v-if="isLoadingLogin"
                        class="absolute top-0 left-0 right-0 bottom-0 bg-white/70 dark:bg-gray-800/70 z-[999]">
                        <div role="status" class="absolute -translate-x-1/2 -translate-y-1/2 top-2/4 left-1/2">
                            <svg aria-hidden="true"
                                class="w-10 h-10 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-green-600"
                                viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z"
                                    fill="currentColor" />
                    ...
                    <form @submit.prevent="loginSubmit" method="post" action="" class="">
                        ...
                        <div class="relative mb-3">
                            ...
                            <input required type="text" v-model="loginForm.email" name="email" class="input-group"
                        ...
                        <div class="relative mb-6">
                            ...
                            <input required :type="typeInputPassword" v-model="loginForm.password" name="password"
                                class="input-group pr-[40px]" :placeholder="$t('Type the password')">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-300 mb-6">Novo por aqui? <a href=""
                                @click.prevent="hideLoginShowRegisterToggle"><strong>Criar conta</strong></a></p>
                    </form>
                    ...
                    <!-- <div class="login-wrap mt-5">
                        ...
                        <div class="social-group mt-3">
                            <a :href="redirectSocialTo()"
                                class="text-green-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-600 dark:focus:ring-blue-800">
                ...
                <div class="w-full relative p-5 m-auto">
                    <form @submit.prevent="registerSubmit" method="post" action="" class="">
                        ...
                        <div class="relative mb-3">
                            ...
                            <input type="text" name="name" v-model="registerForm.name" class="input-group"
                        ...
                        <div class="relative mb-3">
                            ...
                            <input type="email" name="email" v-model="registerForm.email" class="input-group"
                        ...
                        <div class="relative mb-3">
                            ...
                            <input :type="typeInputPassword" name="password" v-model="registerForm.password"
                                class="input-group pr-[40px]" :placeholder="$t('Type the password')" required>
                            <button type="button" @click.prevent="togglePassword"
                                class="absolute inset-y-0 right-0 flex items-center pr-3.5 ">
                                <i v-if="typeInputPassword === 'password'" class="fa-regular fa-eye"></i>
                                <i v-if="typeInputPassword === 'text'" class="fa-sharp fa-regular fa-eye-slash"></i>
                        ...
                        <div class="mb-3 mt-5">
                            <button @click.prevent="isReferral = !isReferral" type="button"
                            ...
                            <div v-if="isReferral" class="relative mb-3 mt-1">
                                ...
                                <input type="text" name="name" v-model="registerForm.reference_code" class="input-group"
                                    :placeholder="$t('Code')">
                            </div>
                        </div>
                    ...
                    <div class="login-wrap mt-5">
                        ...
                        <div class="social-group mt-3">
                            <a :href="redirectSocialTo()"
                                class="text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-600 dark:focus:ring-blue-800">
                                <i class="fa-brands fa-google"></i>
                            </a>
                        </div>
                    </div>
...
export default {
    ...
    watch: {
        ...
        invite: function (newVal, oldVal) { // watch it
            this.$props.invite = newVal;
        },
    },
};
</script>
