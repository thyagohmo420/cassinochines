<template>
    <div class="block">
        <!-- <div v-if="(paymentType == null || paymentType === '') && wallet && setting">
            <div class="">
                <ul>
                    <li v-if="setting.digitopay_is_enable" @click="setPaymentMethod('pix', 'digitopay')" class="background cursor-pointer flex justify-between hover:bg-green-700/20 px-4 py-3 mb-3">
                    ...
                    <li v-if="setting.ezzebank_is_enable" @click="setPaymentMethod('pix', 'ezzebank')" class="background cursor-pointer flex justify-between hover:bg-green-700/20 px-4 py-3 mb-3">
                        <div class="flex items-center gap-4">
                            <img :src="`/assets/images/pix.png`" alt="" width="100">
                            <p>Ezzebank</p>
                        </div>
                    ...
                    <li v-if="setting.mercadopago_is_enable" @click="setPaymentMethod('pix', 'mercadopago')" class="background cursor-pointer flex justify-between hover:bg-green-700/20 px-4 py-3 mb-3">
                        <div class="flex items-center gap-4">
                            <img :src="`/assets/images/pix.png`" alt="" width="100">
                            <p>MERCADO PAGO</p>
                        </div>
                    ...
                    <li v-if="setting.sharkpay_is_enable" @click="setPaymentMethod('pix', 'sharkpay')" class="background cursor-pointer flex justify-between hover:bg-green-700/20 px-4 py-3 mb-3">
                        <div class="flex items-center gap-4">
                            <img :src="`/assets/images/pix.png`" alt="" width="100">
                            <p>SHARKPAY</p>
                        </div>
                    ...
                    <li v-if="setting.suitpay_is_enable" @click="setPaymentMethod('pix', 'suitpay')" class="background cursor-pointer flex justify-between hover:bg-green-700/20 px-4 py-3 mb-3">
                        <div class="flex items-center gap-4">
                            <img :src="`/assets/images/pix.png`" alt="" width="100">
                            <p>SUITPAY</p>
                        </div>
                    ...
                    <li v-if="setting.stripe_is_enable" @click="setPaymentMethod('stripe', 'stripe')" class="background cursor-pointer flex justify-between hover:bg-green-700/20 px-4 py-3 mb-2">
                        <div>
        ...
        <div v-if="setting && paymentType === 'pix' && (setting.suitpay_is_enable || setting.mercadopago_is_enable || setting.digitopay_is_enable || setting.ezzebank_is_enable)">
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.paymentGateway = this.setting.default_gateway;
...
.dark .dark\:bg-gray-900 {
    background-color: rgba(28, 30, 34, .2) !important;
}
</style>
