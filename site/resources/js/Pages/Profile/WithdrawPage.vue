<template>
    <BaseLayout>
        <div class="md:w-11/12 2xl:w-4/6 mx-auto px-4 md:px-0 mt-20">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="col-span-1 hidden md:block">
                    <WalletSideMenu/>
                </div>
                <div class="col-span-2 relative">
                    <div v-if="setting != null && wallet != null && isLoading === false" class="flex flex-col w-full  shadow-lg border background p-4 rounded">
...
.dark .dark\:bg-gray-900, .dark\:bg-gray-700 {
