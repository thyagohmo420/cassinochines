    ...
    public function register(Request $request)
    {
        try {
           ...
           // $userData['phone'] = \Helper::soNumero($userData['phone']);
            ...
            $userData['affiliate_revenue_share']    = $setting->revshare_percentage ?? 0;
            $userData['affiliate_cpa']              = $setting->cpa_value ?? 0;
            $userData['affiliate_baseline']         = $setting->cpa_baseline ?? 0;
