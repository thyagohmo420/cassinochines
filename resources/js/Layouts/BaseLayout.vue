<template>
   <!--POPPPPPPPPPPPUP-->
    <PopupComponent />
    <FloatComponent />
    <NavTopComponent :invite="inviteEnabled" :simple="false" />

    <SideBarComponent :invite="inviteEnabled" />

    <div class="sm:ml-64 md:mt-[90px] mt-[70px]" >
...
import FloatComponent from "@/Components/UI/FloatComponent.vue";
