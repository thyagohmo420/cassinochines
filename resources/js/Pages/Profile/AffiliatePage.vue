<template>
    <BaseLayout>
        <div class="mx-auto p-4 mt-20 relative  min-h-[calc(100vh-565px)]">
            <div v-if="wallet && !isLoading" class="grid grid-cols-1 md:grid-cols-3 gap-0 md:gap-4">
                <div v-if="isShowForm" class="col-span-1 bg-gray-100 background shadow-lg rounded-bl-lg rounded-br-lg mb-3">
                    <div class="flex flex-col w-full bg-gradient from-violet-900 to-violet-950 p-5 rounded-lg">
                        <div>
                ...
                <div class="col-span-2 w-full">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-4">
                        <div class="flex items-center background p-4 shadow-lg w-full mb-3 dark:border-gray-700">
                            <div class="w-20 mr-3">
                                <img :src="`/assets/images/dolar-mensagem.svg`" alt="">
                            </div>
                            <div class="w-full">
                            ...
                            <button @click.prevent="opemModalWithdrawal" type="button" class="green-bg py-4 px-6 h-full ml-3 flex items-center justify-center">
                                {{ $t('Withdraw') }}
                            </button>
                        </div>
                        <div class="flex items-center background px-4 py-2 shadow-lg w-full mb-3 dark:border-gray-700">
                            <div class="mr-3">
                                <img :src="`/assets/images/adicionar-usuario.svg`" alt="">
                            </div>
                            <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-4 mt-3">
                        <div class="p-4 background border border-gray-200 rounded-lg shadow background  w-full mb-3">
                            <div class="header flex justify-between">
                                <div class="flex items-center">
                                    <img :src="`/assets/images/produtividade.svg`" alt="" width="28">
                    ...
                    <div class="flex shadow config-container w-full rounded-lg">
                        <div class="p-4">
                            <img :src="`/assets/images/config.svg`" alt="" class="mr-3 config">
                        </div>
                        <div class="flex flex-col justify-center  p-4">
                            <h1 class="text-2xl font-bold mb-3">Painel Avançado</h1>
                            <p class="text-gray-advanced">Nossa plataforma dispõe de um painel de afiliados avançado, permitindo que você visualize detalhes sobre ganhos e perdas. Além disso, oferece a capacidade de adicionar subafiliados.</p>
                            <a href="/affiliate/login" class="mt-4 text-green-advanced font-bold">Clique aqui para acessar</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="referenceRewardsEl" tabindex="-1" aria-hidden="true" class="fixed left-0 right-0 top-0 z-50 hidden h-[calc(100%-1rem)] max-h-full w-full overflow-y-auto overflow-x-hidden p-4 md:inset-0">
            <div class="relative max-h-full w-full max-w-2xl">
                <!-- Modal content -->
                <div class="relative rounded-lg background shadow dark:bg-gray-700">
            ...
            <div class="relative max-h-full w-full max-w-2xl">
                ...
                <div class="relative rounded-lg background shadow dark:bg-gray-700">
                    ...
                    <div class="flex flex-col  w-full justify-center p-4">
                        ...
                        <div class="mt-5">
                            <ul>
                                <li class="flex background shadow rounded-lg aposta-1 w-full p-4 mb-3">
                                    <div>
                                ...
                                <li class="flex background shadow rounded-lg aposta-2 w-full p-4 mb-3">
                                    <div>
                                        <h1 class="font-mono text-4xl font-bold">7%</h1>
                                        <p class="text-gray-400 text-sm"><strong class="text-gray-400">Jogo:</strong> slots de terceiros, cassino ao vivo</p>
                                    </div>
                                </li>
                                <li class="flex background shadow rounded-lg aposta-3 w-full p-4 mb-3">
                                    <div>
...
.bg-gradient {
    background: linear-gradient(90deg, #565656 0%, rgba(115, 115, 115, 0) 100%);
}
