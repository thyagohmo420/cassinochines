<template>
    <aside :class="[
        ...
        class="top-[65px] fixed flex items-center left-0 z-50 w-64  h-screen transition-transform -translate-x-full sm:translate-x-0 sidebar-color custom-side-shadow"
        aria-label="Sidebar">
        <div class="h-full pb-4 overflow-y-auto sidebar-color p-4">
            <div class="mt-4">
                <div class="grid grid-cols-2 gap-4 mb-4" v-if="isLoading">
                    <div v-for="i in 10"
                        class="flex items-center justify-center h-20 max-w-sm rounded-xl animate-pulse bg-gray-100 dark:bg-gray-700">

                    </div>
                </div>
                <div v-else class="grid grid-cols-2 gap-4 mt-4 mb-4">
                    <RouterLink :to="{ name: 'home' }" active-class="category-active"
                        class="site-menu-item flex flex-col items-center justify-center text-center p-3  rounded-xl">
                        <img src="/public/assets/images/SVG(12) (4).svg" alt="" width="35">
            ...
            <div class="grid grid-cols-2 gap-4">
                <RouterLink :to="{ name: 'favoritePage' }" active-class="category-active"
                    class="site-menu-item flex flex-col items-center justify-center text-center p-3 rounded-xl">
                    <img src="/public/assets/images/SVG(12) (3).svg" alt="" width="35">
                    <span class="text-[12px] mt-2">{{ $t('Favorites') }}</span>
                </RouterLink>
                <RouterLink :to="{ name: 'recentsPage' }" active-class="category-action"
                    class="site-menu-item flex flex-col items-center justify-center text-center p-3 rounded-xl">
                    <img src="/public/assets//images/Union 199.svg" alt="" width="27">
                    <span class="text-[12px] mt-2">{{ $t('Recents') }}</span>
                </RouterLink>
            </div>

            <div class="grid grid-cols-2 gap-4 mt-4">
                <div>
                    <a href="/landing/spin" active-class="category-action" class="relative">
                        <img :src="`/assets/images/eventos.png`" alt="" class="w-full">
                        <h1 class="absolute bottom-[25px] text-600  left-[5px]">Eventos</h1>
                    </a>
                </div>
                <div>
                    <RouterLink :to="{ name: 'recentsPage' }" active-class="category-action" class="relative">
                        ...
                        <h1 class="absolute bottom-[25px] text-600 left-[5px]">{{ $t('Recents') }}</h1>
                    </RouterLink>
                </div>
                <div>
                    <button @click.prevent="toggleMissionModal" active-class="category-action" class="relative">
                        <img :src="`/assets/images/pendente.png`" alt="" class="w-full">
                        <h1 class="absolute bottom-[25px] text-600 left-[5px]">{{ $t('Awards') }}</h1>
                    </button>
                </div>
                <div>
                    <RouterLink :to="{ name: 'recordPage' }" active-class="category-action" class="relative">
                        ...
                        <h1 class="absolute bottom-[25px] text-600 left-[5px]">{{ $t('Records') }}</h1>
                    </RouterLink>
                </div>
                <div>
                    <RouterLink :to="{ name: 'vipPage' }" active-class="category-action" class="relative">
                        <img :src="`/assets/images/vip.png`" alt="" class="w-full">
                        <h1 class="absolute bottom-[25px] text-600 left-[5px]">{{ $t('Vip') }}</h1>
                    </RouterLink>
                </div>
                <div>
                    <RouterLink :to="{ name: 'bonusPage' }" active-class="category-action" class="relative">
                        ...
                        <h1 class="absolute bottom-[25px] text-600 left-[5px]">{{ $t('Bonus') }}</h1>
                    </RouterLink>
                </div>
            </div>
            ...
            <ul class="font-medium mt-5 mb-[200px]">
                <li class="px-3">
                    <a @click="$router.push('/support')" href="#"
                        class="l-5 flex items-center w-full p-2 text-white font-normal transition duration-700 rounded-lg group dark:white dark:hover:text-white">
                        <svg style="filter: invert(100%) brightness(1200%);" width="16" height="16" viewBox="0 0 16 16"
                    ...
                    <a @click="$router.push('/support')" href="#"
                        ...
                        <svg style="filter: invert(100%) brightness(1200%);" width="16" height="16" viewBox="0 0 16 16"
                            ...
                            <path
                                ...
                                fill="#8C9099"></path>
                            <path
                                d="M13.8 8.89999C12.7 10.6 10.8 11.8 8.60001 12L10.5 16L12.4 12.9L16 13.4L13.8 8.89999Z"
                                fill="#414952"></path>
                ...
                <li class="px-3">
                    <a @click="$router.push('/support')" href="#"
                        class="l-5 flex items-center w-full p-2 text-white font-normal transition duration-700 rounded-lg group dark:white dark:hover:text-white">
                        <svg style="filter: invert(100%) brightness(1200%);" width="17" height="17" viewBox="0 0 17 17"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <li class="px-3">
                    <a @click="$router.push('/support-center')" href="#"
                        class="transition duration-700 bg-gray-100 dark:bg-transparent hover:bg-gray-200 dark:hover:bg-transparent flex items-center p-2 text-white font-normal rounded-lg dark:white dark:hover:text-white group">
                        <svg style="filter: invert(100%) brightness(1200%);" width="16" height="16" viewBox="0 0 16 16"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
