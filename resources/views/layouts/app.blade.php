...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@100;200;300;400;500;600;700&family=Roboto:ital,wght@0,100..900;1,100..900&display=swap" rel="stylesheet">        <title>{{ env('APP_NAME') }}</title>
        ...
        <style>
            body{
                font-family: {{ $custom['font_family_default'] ?? "'Roboto', sans-serif" }};
            }
            :root {
                --ci-primary-color: {{ $custom['primary_color'] }};
                --ci-category-color: {{ $custom['category_color'] }};
                ...
                --button-text: {{ $custom['button_text'] }};
            ...
            .category-img-color {
                filter: {{ $custom['category_img_color'] }};
            }
        </style>
